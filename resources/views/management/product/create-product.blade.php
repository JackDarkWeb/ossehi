<div class="product-single-container product-single-default product-quick-view container">
    ...
    <div class="container">
            ...
            <form method="post" action="#" class="mb-1" id="product-form">
                        ...
                        <div class="select-custom mb-2">
                            ...
                            <select name="category" id="category" class="form-control form-control-sm">
                                ...
                                @foreach(menu_sub_category_products() as $sub_category)
                                    <option value="{{ $sub_category->id }}" >{{ __(ucfirst($sub_category->name))  }}</option>
                                @endforeach
                ...
                <div class="col-md-6">
                    ...
                    <div class="select-custom mb-2 form-group">
                        ...
                        <select name="type" id="type" class="form-control form-control-sm">
                            ...
                            <option value="simple" >{{ strtoupper(__( 'simple')) }}</option>
                            <option value="vip">{{ strtoupper(__( 'VIP')) }}</option>
