    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <form method="post" action="{{ route('request.discount.store_product', ['lang' => app()->getLocale(), 'product_id' => $product_id, 'slug' => $slug, 'price' => $price, 'devise' => $devise]) }}" class="mb-1" id="discount-form" data-id="{{ $product_id }}">
