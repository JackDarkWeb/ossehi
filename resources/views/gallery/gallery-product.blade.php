    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-8 m-2">
                        ...
                        <form method="post" action="{{ route_name('request.gallery.product', ['slug' => $product->slug]) }}" enctype="multipart/form-data" class="dropzone" id="my-awesome-dropzone">
                            @csrf
                ...
                <div class="row justify-content-center">
                    ...
                    @foreach($product->galleries as $image)
                        ...
                        <div class="col-2 mb-4" id="gallery-product{{$image->id}}">
                            ...
                            <form method="post" id="delete-gallery" action="{{ route_name('destroy.gallery.product', ['id' => $image->id]) }}">
                                @csrf
                                @method('DELETE')
            ...
            <div class="form-footer justify-content-center">
                <a href="{{ route_name('product', ['slug' => $product->slug]) }}" class="btn btn-primary btn-md">{{strtoupper(__('View the product'))}}</a>
            </div><!-- End .form-footer -->
