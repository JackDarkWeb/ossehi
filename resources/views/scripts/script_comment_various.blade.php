    ...
    $(function () {
        ...
        $doc.on('submit', '#comment-form', function (event) {
            ...
            if (Validator.getValue(this, '#comment')){
                ...
                Validator.requestAjax('POST', "{{ route_name('comments.various') }}", func_callback, request);
        ...
        function fetchLatestComments() {
            ...
            Validator.requestAjax('GET', "{{ route('comments.various.fetch', ['lang' => app()->getLocale(), 'various_id' => $various->id]) }}", func_fetch_callback);
        }
